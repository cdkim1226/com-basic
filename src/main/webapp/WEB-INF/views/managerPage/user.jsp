    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
      ...
      <div class="collapse navbar-collapse justify-content-between" id="navbar">
        <div class="navbar-nav">
          ...
          <a class="nav-item nav-link active" href="./user.html">회원</a>
        </div>
      ...
      <div class="container p-3 bg-dark text-white">
        <div class="row">
          <div class="col-sm-9 info">
            <h4><img src="./img/userSmall.svg"> 회원<small>페이지를 관리하세요.</small></h4>
          </div>
          <div class="col-sm-3">
            <div class="btn-group float-right">
              ...
              <div class="dropdown-menu">
                ...
                <a class="dropdown-item active" href="./user.html" >회원 관리</a>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-md-3">
            <div class="list-group">
              ...
              <a href="./event.html" class="list-group-item">이벤트 관리<span class="badge badge-secondary">25</span></a>
              <a href="./blog.html" class="list-group-item">블로그 관리</a>
              <a href="./user.html" class="list-group-item active">회원 관리<span class="badge badge-secondary">25</span></a>
            </div>
            <div class="p-2 my-2">
