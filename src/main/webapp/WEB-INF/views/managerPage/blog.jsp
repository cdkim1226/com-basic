    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
      ...
      <div class="collapse navbar-collapse justify-content-between" id="navbar">
        <div class="navbar-nav">
          ...
          <a class="nav-item nav-link active" href="./blog.html">블로그</a>
      ...
      <div class="container p-3 bg-dark text-white">
        <div class="row">
          <div class="col-sm-9 info">
            <h4><img src="./img/editSmall.svg"> 블로그<small>페이지를 관리하세요.</small></h4>
          </div>
          <div class="col-sm-3">
            <div class="btn-group float-right">
              ...
              <div class="dropdown-menu">
                <a class="dropdown-item" href="./index.html" >대시보드</a>
                <a class="dropdown-item" href="./event.html">이벤트 관리</a>
                <a class="dropdown-item active" href="./blog.html" >블로그 관리</a>
        ...
        <div class="row">
          <div class="col-md-3">
            <div class="list-group">
              <a href="./index.html" class="list-group-item">대시보드</a>
              <a href="./event.html" class="list-group-item">이벤트 관리</a>
              <a href="./blog.html" class="list-group-item active">블로그 관리<span class="badge badge-secondary">12</span></a>
            ...
            <div class="p-2 my-2">
              ...
              <div class="progress" style="Height: 20px; background-color: #f2f2f2">
                  ...
                  role="progressbar" style="width: 50%;" aria-valuenow="10" aria-valuemin="0" aria-valuemax="100">
                  </div>
              </div>
              <h5 class="mt-2">디스크 점유율</h5>
              <div class="progress" style="Height: 20px; background-color: #f2f2f2">
                  <div class="progress-bar progress-bar-striped bg-danger progress-bar-animated"
                  role="progressbar" style="width: 75%;" aria-valuenow="10" aria-valuemin="0" aria-valuemax="100">
                  </div>
              </div>
              <h5 class="mt-2">트래픽</h5>
              <div class="progress" style="Height: 20px; background-color: #f2f2f2">
                  <div class="progress-bar progress-bar-striped bg-warning progress-bar-animated"
                  role="progressbar" style="width: 100%;" aria-valuenow="10" aria-valuemin="0" aria-valuemax="100">
                  </div>
              </div>
            </div>
            <div class="p-2 my-2">
              <div class="card text-center pt-2 bg-light">
                ...
                <div class="card-footer text-musted">
                  12분 전
                </div>
              </div>
            </div>
            ...
            <div class="col-md-9">
              <div class="list-group">
                ...
                <div class="list-group-item">
                  <div class="list-group">
                    <div class="list-group">
                      <a href="#" class="list-gruop=item list-group-item-action flex-column align-items-start active">
                          <div class="d-flex w-100 justify-content-between">
                            <h5 class="mb-1">Net Framework 3.5 문제 해결하는 방법!</h5>
                            <small style="width: 120px; text-align: right;">1일 전</small>
                          </div>
                          <p class="mb-1">안녕하세요, 익친님들!</p>
                          <small>좋아요 17개</small>
                      </a>
                      <a href="#" class="list-gruop=item list-group-item-action flex-column align-items-start active">
                          <div class="d-flex w-100 justify-content-between">
                      ...
                      <a href="#" class="list-gruop=item list-group-item-action flex-column align-items-start active">
                          ...
                          <p class="mb-1">개발환경 구축 방법</p>
                          <small>좋아요 30개</small>
                      </a>
                    </div>
                  </div>
                  <button class="btn btn-success mt-2" data-toggle="modal" data-target="#modal">
                    글 작성
                  </button>
                </div>
              </div>
