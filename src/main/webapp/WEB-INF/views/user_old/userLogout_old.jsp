...
<body>
		...
		<div class="collapse navbar-collapse justify-content-between"
			...
			<div class="navbar-nav mr-sm-2">
				<a class="nav-item nav-link" href="userLogin">로그인</a> <a
					class="nav-item nav-link active" href="userLogout">로그아웃</a>
				<a class="nav-item nav-link" href="userEdit">관리자 정보 수정</a>
			</div>
		</div>
	</nav>
	<header id="header">
		<div class="container p-3 bg-dark text-white">
			<div class="row">
				<div class="col-sm-9 info">
					<h4>
						<img src="resources/img/setting.svg"> 로그아웃에<small>성공했습니다.</small>
					</h4>
				</div>
			</div>
		</div>
	...
	<section id="main">
		<div class="container">
			<a href="userLogin" class="btn btn-primary">로그인 페이지로 이동하기</a>
		</div>
	</section>
